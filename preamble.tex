...
\title{
	...
	Segunda Práctica Dirigida\quad Grupo N$^{\circ}$2
}
...
\date{\today} % 22 de septiembre del 2023

\titlegraphic{
	\begin{picture}(0,0)
		\put(-130,80){\makebox(0,0)[rt]{\href{https://www.overleaf.com/read/tkmqxgrvjqtw}{\includegraphics[width=2.5cm]{overleaf}}}}
